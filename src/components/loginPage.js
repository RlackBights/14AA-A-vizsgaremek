          ...
          <div id="button-container">
            <button
              ...
              onClick={() => {
                ...
                if (
                  regex.test(usernameInput.value) ||
                  regex.test(passwordInput.value)
                ) {
                  errorMessage.innerHTML =
                    "One or more fields contain unallowed characters!";
                  errorMessage.className = "show-error";
                  setTimeout(() => {
                    errorMessage.className = "";
                  }, 4000);
          ...
          <div id="button-container">
            <button
              ...
              onClick={() => {
                ...
                if (
                  regex.test(registerName.value) ||
                  regex.test(registerPassword1.value) ||
                  regex.test(registerPassword2.value)
                ) {
                  errorMessage.innerHTML =
                    "One or more fields contain unallowed characters!";
                  errorMessage.className = "show-error";
                        ...
                        function (response) {
                          if (response.status === 200) {
                            response.json().then((json) => {
                              cookie.set("user", json.loginAuthCode);
                            });
